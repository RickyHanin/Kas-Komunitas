  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Komunitas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content ">
      ...
      <div class="row">
          ...
          <div class="col-4">
            <p class="text-right mt-4 "><a href="tambah_data_komunitas.php" class="btn btn-info text-white ">Tambah Komunitas </a></p>
          </div>  
      </div> 
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row"><?= $no++ ?></th>
                      ...
                      <td><?= $data['password']?></td>
                      <td>
                        <a href="edit_data_komunitas.php?id=<?=$data["id_pengguna"]?>"type="button" class="btn btn-warning">Edit</a>  
                        <a href="aksi_data_komunitas.php?del&id=<?=$data["id_pengguna"]?>"type="button" class="btn btn-danger">Delete</a> 
                      </td>
                  </tr>
                  <?php endforeach ?>
                </tbody>
