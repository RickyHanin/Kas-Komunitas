  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Komunitas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card-body">
                <form action="aksi_data_komunitas.php" method="post">
                    <div class="form-group row">
                        <label for="inputnama" class="col-sm-2 col-form-label mb-1">Nama Ketua Komunitas</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputnama" name="nama" value="<?=$data['nama']?>" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputno" class="col-sm-2 col-form-label mb-1">No Hp</label>
                        <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputno" name="no" required="required" value="<?=$data['password']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    <div class="col-sm-10">
                        <button type="submit" class="btn btn-primary mb-2 mt-4" name="edit-komunitas">Edit Data</button>
                    </div>
