        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="data_komunitas.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Komunitas</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Data Komunitas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../das_admin.php">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="data_komunitas.php">Data Komunitas</a></li>
    ...
    <section class="content ">
        <div class="card card-default">
            <div class="card-body">
                <form action="aksi_data_komunitas.php" method="post">
                    <div class="form-group row">
                        <label for="inputnama" class="col-sm-2 col-form-label mb-1">Nama Komunitas</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputnama" name="nama" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputno" class="col-sm-2 col-form-label mb-1">Nomor Hp</label>
                        <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputno" name="no" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary mb-2 mt-4" name="submit-komunitas">Tambah Data</button>
                        </div>
                    </div>
                </form>
            </div>
