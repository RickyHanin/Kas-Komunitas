...
<?php
    ...
    // kas
    $query2= "SELECT * FROM kas where id_pengguna=$id";
  ...
  <div class="content-wrapper">
    ...
    <section class="content ">
      ...
      <div class="row">
          ...
          <div class="col-4">
            <p class="text-right mt-4 "><a href="tambah_kas.php?id=<?=$data["id_pengguna"]?>" class="btn btn-info text-white ">Tambah Pembayaran </a></p>
          </div> 
            ...
            <div class="card " >
            <div class="card-body">
            <h2 class="m-0 mt-3 ml-4">Detail Pembayaran dari :</h2>
            <h4 class="m-0 mt-3 ml-4"><?= $data['nama']?></h4>
              <table id="example1" class="table table-bordered table-striped  ">
                ...
                <tbody>
                  ...
                  <tr>
                  <th scope="row"><?= $no++ ?></th>
                    <td><?= $data2['tgl_bayar']?></td>
                    <td><?= $data2['bulan']?></td>
                    <td><?= $data2['nominal']?></td>
                    <td>
                        <a href="edit_kas.php?id=<?=$data2["id_pengguna"]?>&id2=<?=$data2["id_kas"]?>"type="button" class="btn btn-warning">Edit</a>  
                        <a href="aksi_kas.php?del&id2=<?=$data2["id_kas"]?>&id=<?=$data2["id_pengguna"]?>"type="button" class="btn btn-danger">Delete</a> 
                    </td>
                  </tr>
                  <?php endforeach ?>
                </tbody>
