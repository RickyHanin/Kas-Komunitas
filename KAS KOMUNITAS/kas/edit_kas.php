...
<?php
    ...
    // kas
    $query2= "SELECT * FROM kas where id_kas=$id2";
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="kas.php">Kas Komunitas SDK</a></li>
    ...
    <section class="content ">
        <div class="card card-default">
            <div class="card-body">
            <h5 class="m-0 mt-3 mb-4">Edit Pembayaran Kas <?= $data['nama']?></h5>
                <form action="aksi_kas.php?id4=<?=$data["id_pengguna"]?>&id5=<?=$data2["id_kas"]?>" method="post">
                    <div class="form-group row">
                        <label for="inputnama" class="col-sm-2 col-form-label mb-1">Bulan </label>
                        <div class="col-sm-10 ">
                              <select class="form-control  "id="inputnama" name="bulan" required="required" style="width: 100%;" disabled>
                                <option <?php if (in_array("Januari", $bulan)) echo "selected" ?>> Januari</option>
                                <option <?php if (in_array("Februari", $bulan)) echo "selected" ?>>Februari </option>
                                <option <?php if (in_array("Maret", $bulan)) echo "selected" ?>>Maret</option>
                                <option <?php if (in_array("April", $bulan)) echo "selected" ?>>April</option>
                                <option <?php if (in_array("Mei", $bulan)) echo "selected" ?>>Mei</option>
                                <option <?php if (in_array("Juni", $bulan)) echo "selected" ?>>Juni</option>
                                <option <?php if (in_array("Juli", $bulan)) echo "selected" ?>>Juli</option>
                                <option <?php if (in_array("Agustus", $bulan)) echo "selected" ?>>Agustus</option>
                                <option <?php if (in_array("September", $bulan)) echo "selected" ?>>September</option>
                                <option <?php if (in_array("Oktober", $bulan)) echo "selected" ?>>Oktober</option>
                                <option <?php if (in_array("November", $bulan)) echo "selected" ?>>November</option>
                                <option <?php if (in_array("Desember", $bulan)) echo "selected" ?>>Desember</option>
                              </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="date"  class="form-control" id="inputtgl" name="tgl" required="required" value="<?=$data2['tgl_bayar']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary mb-2 mt-4 "  name="edit-kas">Edit Data</button>
                        </div>
                    </div>
                </form>
            </div>
