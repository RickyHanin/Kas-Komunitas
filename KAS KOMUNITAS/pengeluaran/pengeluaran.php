...
<?php
  include '../koneksi.php';
  //ambil data iuran
  $pengeluaran= "SELECT sum(nominal_pengeluaran) as jumlah from pengeluaran";
  $result= mysqli_query($koneksi,$pengeluaran);
  ...
  <div class="content-wrapper">
    ...
    <section class="content ">
      ...
      <div class="row">
          ...
          <div class="col-4">
            <p class="text-right mt-4 "><a href="tambah_pengeluaran.php" class="btn btn-info text-white ">Tambah Pengeluaran </a></p>
          </div>  
      </div> 
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row"><?= $no++ ?></th>
                      ...
                      <td>
                        <a href="edit_pengeluaran.php?id=<?=$data["id_pengeluaran"]?>"type="button" class="btn btn-warning">Edit</a>  
                        <a href="aksi_pengeluaran.php?del&id=<?=$data["id_pengeluaran"]?>"type="button" class="btn btn-danger">Delete</a> 
                      </td>
                  </tr>
                  <?php endforeach ?>
                </tbody>
