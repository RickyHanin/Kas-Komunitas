  ...
  <div class="content-wrapper">
    ...
    <section class="content ">
        <div class="card card-default">
            <div class="card-body">
            <form action="aksi_pengeluaran.php" method="post">
                    <div class="form-group row">
                        <label for="inputnama" class="col-sm-2 col-form-label mb-1">Nama </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputnama" name="nama" value="<?=$data['nama_pengeluaran']?>" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputket" class="col-sm-2 col-form-label mb-1">keterangan</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputket" name="ket" value="<?=$data['keterangan_pengeluaran']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputtgl" class="col-sm-2 col-form-label mb-1">Tanggal</label>
                        <div class="col-sm-10">
                          <input type="date"  class="form-control" id="inputtgl" name="tgl" required="required"value="<?=$data['tgl_pengeluaran']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputnominal" class="col-sm-2 col-form-label mb-1">Nominal</label>
                        <div class="col-sm-10">
                          <input type="number" class="form-control" id="inputnominal" name="nom" required="required" value="<?=$data['nominal_pengeluaran']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary mb-2 mt-4" name="edit-pengeluaran">Edit Data</button>
                        </div>
                    </div>
