            ...
            <div class="card-body">
                <form action="aksi_data_admin.php" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputpassword" name="password" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary mb-2 mt-4" name="submit-admin">Tambah Data</button>
                        </div>
                    </div>
                </form>
            </div>
