...
<?php
  ...
  //tampil data
  $query= "SELECT * FROM pengguna where level= 'admin'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content ">
      ...
      <div class="row">
          ...
          <div class="col-4">
            <p class="text-right mt-4 "><a href="tambah_data_admin.php" class="btn btn-info text-white ">Tambah Admin </a></p>
          </div>  
      </div> 
        ...
        <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-striped ">
              ...
              <tr>
                  ...
                  <td><?= $data['password']?></td>
                  <td>
                    <a href="edit_data_admin.php?id=<?=$data["id_pengguna"]?>"type="button" class="btn btn-warning">Edit</a>  
                    <a href="aksi_data_admin.php?del&id=<?=$data["id_pengguna"]?>"type="button" class="btn btn-danger">Delete</a> 
                  </td>
              </tr>
              <?php endforeach ?>
              </tbody>
