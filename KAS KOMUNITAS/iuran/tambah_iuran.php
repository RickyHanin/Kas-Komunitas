        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../iuran/iuran.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Iuran</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Iuran Komunitas</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card-body">
                <form action="aksi_iuran.php" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputnama" name="nama" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputket" class="col-sm-2 col-form-label mb-1">keterangan</label>
                        <div class="col-sm-10">
                        <textarea class="form-control" id="inputket" name="ket"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="number"  class="form-control" id="inputnominal" name="nom" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary mb-2 mt-4" name="submit-iuran">Tambah Data</button>
                        </div>
                    </div>
                </form>
            </div>
