...
<?php
    include '../koneksi.php';
    $id= $_GET['id'];
    $query= "SELECT * FROM iuran where id_iuran=$id";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Iuran</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../das_admin.php">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="iuran.php">Iuran Komunitas</a></li>
              <li class="breadcrumb-item active">Edit Data Iuran</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content ">
        <div class="card card-default">
            <div class="card-body">
            <form action="aksi_iuran.php" method="post">
                    <div class="form-group row">
                        <label for="inputnama" class="col-sm-2 col-form-label mb-1">Nama </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputnama" name="nama" value="<?=$data['nama_iuran']?>" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputket" class="col-sm-2 col-form-label mb-1">keterangan</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputket" name="ket" value="<?=$data['keterangan_iuran']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputtgl" class="col-sm-2 col-form-label mb-1">Tanggal</label>
                        <div class="col-sm-10">
                          <input type="date"  class="form-control" id="inputtgl" name="tgl" required="required" value="<?=$data['tgl_iuran']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputnominal" class="col-sm-2 col-form-label mb-1">Nominal</label>
                        <div class="col-sm-10">
                          <input type="number" class="form-control" id="inputnominal" name="nom" required="required" value="<?=$data['nominal_iuran']?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary mb-2 mt-4" name="edit-iuran">Edit Data</button>
                        </div>
                    </div>
                </form>
            </div>
